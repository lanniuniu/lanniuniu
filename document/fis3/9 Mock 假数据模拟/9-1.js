...
/*
步骤
1.准备好假数据文件，如 sample.json 文件，放在服务器的 /mock/sample.json 目录，
确保通过 http://127.0.0.1:8080/mock/sample.json 可访问到。
...
刚说的是把文件放在服务器目录，操作起来其实并不是很方便，这类假数据文件建议放在项目源码中，
然后通过 fis3 release 伴随源码一起发布到调试服务器。
 */
